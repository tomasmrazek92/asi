...
export function initAutoVideo() {
  ...
  (() => {
    ...
    var g = `${a}-support`;
    var B = 'https://cdn.jsdelivr.net/npm/@finsweet/attributes-support@1/support.js';
    var R = async () => {
    ...
    var v = ({ scriptAttributes: o, attributeKey: e, version: i, init: s }) => {
      ...
      (n.version = i),
        (n.init = s),
        t || (window.Webflow || (window.Webflow = []), window.Webflow.push(() => s(r)));
    };
    ...
    var V = () => {
      ...
      let e = {
        ...
        destroy() {
          var i, s;
          for (let t of o)
            (s = (i = window.fsAttributes[t]) == null ? void 0 : i.destroy) == null || s.call(i);
        },
      };
      S(e, o);
      C(e);
